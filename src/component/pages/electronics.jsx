...
import elctrData from '../data/electronics.json'
const Electronics = () => {
    ...
    return (
        ...
        <div className="col-6"style={{textAlign:'center',display:"inline-block",borderLeft:"1px solid #c8c8c8 "}}>
            ...
            <div className="row col-12" id="header_name">
                <div className="col-12" style={{textAlign:"center",fontFamily:`'Dosis', sans-serif`,fontWeight:"bold",fontSize:"23px"}}><p>ELECTRONICS</p></div>
            </div>
            <div className="row col-12"id="div_show_page_name">
                <div className="col-12">
                    <p style={{fontFamily:`'Dosis', sans-serif`}}>HOME ‣</p> <p id="smalii"style={{fontFamily:`'Dosis', sans-serif`,fontWeight:"bold"}}>ELECTRONICS</p>
                    </div>
            </div>
            <div className="row col-12" style={{fontFamily:`'Dosis', sans-serif`}}>
            <div className="col-12">
                <div class="row col-12">
                {elctrData.map((name,id)=>{
                return(
