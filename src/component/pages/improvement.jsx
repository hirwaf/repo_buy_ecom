...
import homeM from '../data/home.json'
  ...
  const history = useHistory();
    ...
    return (
        ...
        <div className="left_side">
           ...
           <hr id="line_2"/>
                    <ul id="list_of_buy2">
               <li id="actions">HOME IMPROVEMENT</li>
        ...
        <div className="col-6"style={{textAlign:'center',display:"inline-block",borderLeft:"1px solid #c8c8c8 "}}>
            ...
            <div className="row col-12" id="header_name">
                <div className="col-12" style={{textAlign:"center",fontFamily:`'Dosis', sans-serif`,fontWeight:"bold",fontSize:"23px"}}><p>HOME IMPROVEMENT</p></div>
            </div>
            <div className="row col-12"id="div_show_page_name">
                <div className="col-12">
                    <p style={{fontFamily:`'Dosis', sans-serif`}}>HOME ‣</p> <p id="smalii"style={{fontFamily:`'Dosis', sans-serif`,fontWeight:"bold"}}>HOME IMPROVEMENT</p>
                    </div>
            </div>
